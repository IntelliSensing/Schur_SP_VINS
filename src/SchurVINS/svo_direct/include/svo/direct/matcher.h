...
public:
  ...
  static const int kHalfPatchSize = 4; //4;
  ...
  struct Options
  {
    ...
    int align_max_iter = 30; //10;                //!< number of iterations for aligning the feature patches in gauss newton
    double max_epi_length_optim = 2.0;      //!< max length of epipolar line to skip epipolar search and directly go to img align
    size_t max_epi_search_steps = 200; //100;      //!< max number of evaluations along epipolar line
